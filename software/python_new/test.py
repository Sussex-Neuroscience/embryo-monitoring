...
video_input = '/home/andre/Desktop/maze_test.mp4'


#get the identification of each grating
grating_id = pd.read_csv("grating_maps.csv",index_col=0)
...
video_ongoing=True
    ...
    while video_ongoing:
        ...
        if cv.waitKey(1) & 0xFF in [ord('q'), 27]:
            video_ongoing=False# Quit on 'q' or ESC
        ...
        for item in rois:
            ...
            [item] = np.sum(areas[item])<thresholds[item]/2
