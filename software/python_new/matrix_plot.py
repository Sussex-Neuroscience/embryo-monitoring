...
#norm_brightness = norm_brightness/np.max(norm_brightness)
...
# if plot:
#     
#     axs[0][0].imshow(frame,cmap="binary_r",vmin=0,vmax=255)
#     axs[0][0].set_title("raw_data")
# 
#     axs[0][1].imshow(frame_mask,cmap="binary_r",vmin=0,vmax=255)
#     axs[0][1].set_title("thresholded")
# 
#     axs[0][2].plot(vertical_collapse/np.max(vertical_collapse)*255,transform= rot + base)
# 
